...
threadtypelistFrame.init = function (self,parent,frameid)
	...
	self.areathreadtypelistarea = gm_xinbanchunzhongyun.threadtypelistareaArea(self)
		...
		if self.areathreadtypelistarea.set_title then
			self.areathreadtypelistarea:set_title('threadtypelist')
		elseif self.areathreadtypelistarea.set then
			self.areathreadtypelistarea:set('title','threadtypelist')
		end
