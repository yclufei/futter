...
cgfcustomerlistareaArea.init = function (self,parent,aid)
	...
	local status, msg = xpcall(function ()
	        top:init_control('czy_customer',self:get_sort_order(), GmBase.czynet.get_instance(),'cgfcustomerlist',10)
...
cgfcustomerlistareaArea.callback = function(self,callbackey,tbname,postparam,data)
	local cap,_ = GmBase.objectlistArea.callback(self,callbackey,tbname,postparam,data)
	if cap == false and callbackey == 'czynet.cgfcustomerlist' then
