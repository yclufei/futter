...
cgfusermodifyareaArea = inherit(GmCtrl.ControlBase):name("cgfusermodifyareaArea")

cgfusermodifyareaArea.init = function (self,parent,aid)

	local top = self
	local fid = aid or "cgfusermodifyareaArea"
...
cgfusermodifyareaArea.callback = function(self,key,tb)
  ...
  if tb.act == 'prev' and table.eq(attrs,tb) then		
		...
		print('cgfusermodifyareaArea callback error ',key,tb)
	end
end



cgfusermodifyareaArea.set_data = function(self,data)
	self.data = data
