...
forumforumlistFrame.init = function (self,parent,frameid)
	...
	self.areaforumforumlistarea = gm_ruanjianwaibaojiaoyisuo.forumforumlistareaArea(self)
...
forumforumlistFrame.on_show = function(self,key)
...
forumforumlistFrame.on_hide = function(self,key)
