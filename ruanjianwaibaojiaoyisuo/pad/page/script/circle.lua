...
circleFrame.on_show = function(self)
			
	if self.areacirclearea.on_show then
		self.areacirclearea:on_show()
	end
			
end


circleFrame.on_hide = function(self)
			
	if self.areacirclearea.on_hide then
		self.areacirclearea:on_hide()
	end		
