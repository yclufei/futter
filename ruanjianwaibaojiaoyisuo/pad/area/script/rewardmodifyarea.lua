...
rewardmodifyareaArea.init = function (self,parent,aid)
	...
	GmCtrl.ControlBase.init(self,parent,fid )
		...
		-- form.lua.xsl form 87 ruanjianwaibaojiaoyisuo/classdata/rewardpost.xml
...
rewardmodifyareaArea.callback = function(self,key,tb)
  ...
  if tb.act == 'prev' and table.eq(attrs,tb) then		
		...
		print('rewardmodifyareaArea callback error ',key,tb)
	end
end
