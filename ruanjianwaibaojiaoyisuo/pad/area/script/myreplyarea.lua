...
myreplyareaArea = inherit(GmCtrl.ControlBase):name("myreplyareaArea")
...
myreplyareaArea.callback = function(self,key,tb)
  ...
  if tb.act == 'prev' and table.eq(attrs,tb) then		
		...
		print('myreplyareaArea callback error ',key,tb)
	end
end
