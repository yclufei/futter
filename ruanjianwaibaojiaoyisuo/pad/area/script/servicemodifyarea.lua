...
servicemodifyareaArea.init = function (self,parent,aid)
	...
	GmCtrl.ControlBase.init(self,parent,fid )
		...
		-- form.lua.xsl form 87 ruanjianwaibaojiaoyisuo/classdata/servicepost.xml
...
servicemodifyareaArea.callback = function(self,key,tb)
  ...
  if tb.act == 'prev' and table.eq(attrs,tb) then		
		...
		print('servicemodifyareaArea callback error ',key,tb)
	end
end
