...
foruminfoareaArea.init = function (self,parent,aid)
	...
	self.scrollcontainer:set_scroll_container(true)
		...
		self.forumdetail = gm_ruanjianwaibaojiaoyisuo.forumitemItem(self.scrollcontainer)
	...
	self.commentlistarea = gm_ruanjianwaibaojiaoyisuo.commentlistareaArea(self)
