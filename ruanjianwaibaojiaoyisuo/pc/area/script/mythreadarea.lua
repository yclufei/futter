...
mythreadareaArea = inherit(GmCtrl.ControlBase):name("mythreadareaArea")
...
mythreadareaArea.callback = function(self,key,tb)
  ...
  if tb.act == 'prev' and table.eq(attrs,tb) then		
		...
		print('mythreadareaArea callback error ',key,tb)
	end
end
