...
categarylistMiddleArea = inherit(GmCtrl.ListBase):name("categarylistMiddleArea")

categarylistMiddleArea.init = function(self,parent)
	...
	GmCtrl.ListBase.init(self,parent,"categarylist_middle_area",urls)

	self:set_visible(false)
end


categarylistMiddleArea.set_click_func = function(self,delfunc,detailfunc,updatefunc)
...
categarylistMiddleArea.trans_data = function(self,data)
...
categarylistMiddleArea.init_item = function(self,item)
	local top = self
...
categarylistMiddleArea.setitem = function(self,id,data)
