...
categarylistBigArea = inherit(GmCtrl.ControlBase):name("categarylistBigArea")

categarylistBigArea.init = function(self,parent,fname)
...
categarylistBigArea.set_data = function(self,data)
	self.data = data
