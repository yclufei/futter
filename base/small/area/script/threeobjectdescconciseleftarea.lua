...
threeobjectdescconciseLeftArea = inherit(GmCtrl.ControlBase):name("threeobjectdescconciseLeftArea")

threeobjectdescconciseLeftArea.init = function(self,parent,fname)
...
threeobjectdescconciseLeftArea.on_select = function(self,data)

end


threeobjectdescconciseLeftArea.callback = function(self,callbackey,tbname,postparam,data,sortkey,ids)
...
threeobjectdescconciseLeftArea.set_data = function(self,data)
...
threeobjectdescconciseLeftArea.init_net_data = function(self)
