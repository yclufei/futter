...
categarylistpageMiddleArea = inherit(GmCtrl.ListBase):name("categarylistpageMiddleArea")

categarylistpageMiddleArea.init = function(self,parent)
	...
	GmCtrl.ListBase.init(self,parent,"categarylistpagemiddlearea",urls)

	self:set_visible(false)
end


categarylistpageMiddleArea.set_click_func = function(self,delfunc,detailfunc,updatefunc)
...
categarylistpageMiddleArea.trans_data = function(self,data)
...
categarylistpageMiddleArea.init_item = function(self,item)
	local top = self
...
categarylistpageMiddleArea.setitem = function(self,id,data)
