...
DropList = inherit(GmCtrl.ControlBase):name("DropList")

DropList.init = function (self,parent,frameid)
	local top = self
	local fid = frameid or "base_ctrl_droplist"
...
DropList.set_data = function(self,data)
--	table.print(data)
end

DropList.set_tree_data = function(self,data)
--	table.print(data)
	local id = data['id']
	--g_serverAddress.."tree/objects/page/%d/pagecount/%d/parent_id/%d"
end

DropList.set_tree_rel_data = function(self,data)
