...
favoriteareaArea = inherit(GmCtrl.ControlBase):name("favoriteareaArea")
...
favoriteareaArea.callback = function(self,key,tb)
  ...
  if tb.act == 'prev' and table.eq(attrs,tb) then		
		...
		print('favoriteareaArea callback error ',key,tb)
	end
end
