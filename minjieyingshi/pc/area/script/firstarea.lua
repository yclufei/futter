...
firstareaArea.init = function (self,parent,aid)
	...
	self.searchnav = gm_minjieyingshi.searchnavArea(self)
	...
	self.advmulbig = gm_minjieyingshi.advmulbigArea(self)
	...
	self.advmulbig:SetAttrDirect('alias',"minjieyingshi_templete_first_advmulbig")
	...
	self.iconlist = gm_minjieyingshi.iconlistArea(self)
	...
	self.iconlist:SetAttrDirect('fid',"97")
	...
	self.threeobjectdescconciseleftarea = gm_minjieyingshi.threeobjectdescconciseleftareaArea(self)
