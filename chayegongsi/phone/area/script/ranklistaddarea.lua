...
ranklistaddareaArea.init = function (self,parent,aid)
	...
	self.scrollcontainer:set_scroll_container(true)
		...
		-- form.lua.xsl form 87 chayegongsi/classdata/ranklistpost.xml
	...
	self.mgr = gm_chayegongsi.clsranklistmgr.get_instance()
...
ranklistaddareaArea.set_ref_data = function(self,data)
	table.print(data)
