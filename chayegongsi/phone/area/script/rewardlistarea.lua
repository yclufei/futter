...
rewardlistareaArea.init = function (self,parent,aid)
	...
	self.mgr = gm_chayegongsi.clsrewardmgr(self.movecount)
...
rewardlistareaArea.on_scroll_top = function(self,pwidth,pheight,pxx,topY)	
	local top = self
	self:clean()
...
rewardlistareaArea.alloc_item_ctrl = function(self,idx)
	return gm_chayegongsi.rewarditemItem(self.itemParent,'item'..idx)
end
