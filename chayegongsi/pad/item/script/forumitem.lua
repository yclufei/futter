...
-- D:\GOA\reslibrary\templete\default\pad\item\forumitem\lua.xsl
...
forumitemItem.init = function (self,parent,aid)
	...
	self.avatarclick:set_click(function(avatar)
		print('self.avatar.click')
		local toptop = top
		top.hostWindow:addNavFrame("ursdetail",nil,function(frame) frame:set_data(toptop.data) end)
	end)
	...
	self.pic:set_click(function(avatar)
		local toptop = top
		top.hostWindow:addNavFrame("foruminfo",nil,function(frame) frame:set_data(toptop.data) end)
	end)
	...
	self.message:set_click(function(ctrl)
		local toptop = top
		top.hostWindow:addNavFrame("forumdetail",nil,function(frame) frame:set_data(toptop.data) end)
	end)
