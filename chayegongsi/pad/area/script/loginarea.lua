...
-- D:\GOA\reslibrary\templete\default\pad\area\loginarea\lua.xsl loginarea
...
loginareaArea.init = function (self,parent,aid)
	...
	-- D:\GOA\reslibrary\templete\default\pad\area\loginarea\lua.xsl */username
  self.username = self:get_child('username')
	
	-- D:\GOA\reslibrary\templete\default\pad\area\loginarea\lua.xsl loginform/password
  self.passwdword = self:get_child('passwdword')
	...
	self.thirdlogin = gm_chayegongsi.thirdloginArea(self)
