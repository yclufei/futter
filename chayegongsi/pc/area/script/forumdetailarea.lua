...
forumdetailareaArea = inherit(GmCtrl.ControlBase):name("forumdetailareaArea")

forumdetailareaArea.init = function (self,parent,aid)

	local top = self
	local fid = aid or "forumdetailareaArea"
...
forumdetailareaArea.set_data = function(self,data)
	self.data = data
...
forumdetailareaArea.set_data_id = function(self,data)
	print('forumdetailareaArea.set_data_id',data)
end
