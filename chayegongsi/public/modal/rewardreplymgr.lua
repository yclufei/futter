...
mrewardreplymgr.init = function (self,pagecount)
  ...
  self.action['rewardreplypost']['pid'] = { ['title'] = 'PID' , ['t'] = 'x' , ['min'] = 'NaN' , ['max'] = '20' }	
  self.action['rewardreplypost']['fid'] = { ['title'] = 'FID' , ['t'] = 'x' , ['min'] = 'NaN' , ['max'] = '20' }	
  self.action['rewardreplypost']['tid'] = { ['title'] = 'TID' , ['t'] = 'x' , ['min'] = 'NaN' , ['max'] = '20' }	
  self.action['rewardreplypost']['typeid'] = { ['title'] = '主题分类id' , ['t'] = 'x' , ['min'] = 'NaN' , ['max'] = '20' }	
  self.action['rewardreplypost']['sortid'] = { ['title'] = '分类信息id' , ['t'] = 'x' , ['min'] = 'NaN' , ['max'] = '20' }	
  self.action['rewardreplypost']['cover'] = { ['title'] = '主题封面' , ['t'] = 's' , ['min'] = 'NaN' , ['max'] = '256' }	
  self.action['rewardreplypost']['first'] = { ['title'] = '第一层' , ['t'] = 'x' , ['min'] = 'NaN' , ['max'] = '2' }	
  self.action['rewardreplypost']['author'] = { ['title'] = '用户' , ['t'] = 'x' , ['min'] = 'NaN' , ['max'] = '120' }	
  self.action['rewardreplypost']['authorid'] = { ['title'] = '用户ID' , ['t'] = 'x' , ['min'] = 'NaN' , ['max'] = '2' }	
  self.action['rewardreplypost']['subject'] = { ['title'] = '标题' , ['t'] = 's' , ['min'] = 'NaN' , ['max'] = '120' }	
  self.action['rewardreplypost']['dateline'] = { ['title'] = '发布时间' , ['t'] = 's' , ['min'] = 'NaN' , ['max'] = '20' }	
  self.action['rewardreplypost']['message'] = { ['title'] = '内容' , ['t'] = 's' , ['min'] = 'NaN' , ['max'] = '255' }	
  self.action['rewardreplypost']['invisible'] = { ['title'] = '可视' , ['t'] = 'n' , ['min'] = 'NaN' , ['max'] = '2' }	
  self.action['rewardreplypost']['anonymous'] = { ['title'] = '匿名' , ['t'] = 'n' , ['min'] = 'NaN' , ['max'] = '2' }	
  self.action['rewardreplypost']['usesig'] = { ['title'] = 'sig' , ['t'] = 'x' , ['min'] = 'NaN' , ['max'] = '2' }	
  self.action['rewardreplypost']['digest'] = { ['title'] = '是否精华' , ['t'] = 'x' , ['min'] = 'NaN' , ['max'] = '2' }	
  self.action['rewardreplypost']['rate'] = { ['title'] = '是否评分' , ['t'] = 'x' , ['min'] = 'NaN' , ['max'] = '2' }	
  self.action['rewardreplypost']['closed'] = { ['title'] = '是否关闭' , ['t'] = 'x' , ['min'] = 'NaN' , ['max'] = '2' }	
  self.action['rewardreplypost']['ratetimes'] = { ['title'] = '简介' , ['t'] = 'x' , ['min'] = 'NaN' , ['max'] = '2' }	
  self.action['rewardreplypost']['status'] = { ['title'] = '状态' , ['t'] = 'x' , ['min'] = 'NaN' , ['max'] = '10' }	
  self.action['rewardreplypost']['tags'] = { ['title'] = 'tag' , ['t'] = 'x' , ['min'] = 'NaN' , ['max'] = '2' }	
  self.action['rewardreplypost']['position'] = { ['title'] = '楼层' , ['t'] = 'x' , ['min'] = 'NaN' , ['max'] = '8' }	
  self.action['rewardreplypost']['allownoticeauthor'] = { ['title'] = '' , ['t'] = 'x' , ['min'] = 'NaN' , ['max'] = '2' }	
  self.action['rewardreplypost']['wysiwyg'] = { ['title'] = '' , ['t'] = 'x' , ['min'] = 'NaN' , ['max'] = '2' }	
  self.action['rewardreplypost']['special'] = { ['title'] = '' , ['t'] = 'x' , ['min'] = 'NaN' , ['max'] = '2' }	
  self.action['rewardreplypost']['addfeed'] = { ['title'] = '' , ['t'] = 'x' , ['min'] = 'NaN' , ['max'] = '2' }	
  self.action['rewardreplypost']['uploadalbum'] = { ['title'] = '' , ['t'] = 'x' , ['min'] = 'NaN' , ['max'] = '2' }	
  self.action['rewardreplypost']['adddynamic'] = { ['title'] = '' , ['t'] = 'x' , ['min'] = 'NaN' , ['max'] = '6' }	
  self.action['rewardreplypost']['mod'] = { ['title'] = '' , ['t'] = 'x' , ['min'] = 'NaN' , ['max'] = '20' }	
  self.action['rewardreplypost']['action'] = { ['title'] = '' , ['t'] = 'x' , ['min'] = 'NaN' , ['max'] = '20' }	
  self.action['rewardreplypost']['uid'] = { ['title'] = '' , ['t'] = 'x' , ['min'] = 'NaN' , ['max'] = '20' }	
  self.action['rewardreplypost']['rewardreplyprice'] = { ['title'] = '' , ['t'] = 'n' , ['min'] = 'NaN' , ['max'] = '20' }	
  self.action['rewardreplypost']['posttime'] = { ['title'] = '' , ['t'] = 'n' , ['min'] = 'NaN' , ['max'] = '20' }	
  self.action['rewardreplypost']['fmtuploadtype'] = { ['title'] = '' , ['t'] = 'x' , ['min'] = 'NaN' , ['max'] = '20' }	
  self.action['rewardreplypost']['selectsortid'] = { ['title'] = '' , ['t'] = 'n' , ['min'] = 'NaN' , ['max'] = '20' }
